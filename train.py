...
def train_code_cnn(image_paths, labels):
    ...
    for epoch in range(EPOCH):
        ...
        # 训练样本测试准确率
        test_image_paths, test_labels = get_image_path_labels(IMAGE_TEST_PATH, 200)
        batch_x_test, batch_y_test =  get_random_batch(BATCH_SIZE, test_image_paths, test_labels,200)
    ...
    model_dir = '/home/tuixiang/dataset/pic_num_recognition/model/'
    model_name = "ckp"
...
def get_image_path_labels(IMAGE_PATH, IMAGE_MUMBER):
    ...
    for filename in os.listdir(image_path):
        ...
        lable = filename.split("-")[1].split(".")[0]
        lables.append(lable)
...
def main():
    ...
    image_paths, labels = get_image_path_labels(IMAGE_TRAIN_PATH,IMAGE_MUMBER)
